    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileShares", x => x.ShareId);
                    table.ForeignKey(
                        name: "FK_FileShares_AspNetUsers_SharedWithId",
                        column: x => x.SharedWithId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FileShares_Files_SharedFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileShares_SharedFileId",
                table: "FileShares",
                column: "SharedFileId");
